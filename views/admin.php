	...
	<div id="admin"> 
		<form>
			...
			<div class="update_section" id="section2">
				...
				<div class="container">
					<div class="form-group">
						<ckeditor v-model="values.section2_leftText" id="section2_leftText" :value="values.section2_leftText"></ckeditor>
					</div>
				</div>
			</div>
			...
			<div class="update_section" id="section4">
				...
				<div class="container">
					<div class="form-group">
						<ckeditor v-model="values.section4_content" id="section4_content" :value="values.section4_content"></ckeditor>
					</div>
				</div>
			</div>
